...
\begin{tikzpicture}
  ...
  \nodeunk{111}{(loincomtat.north) ++(0,\linkver)}
  \mklinkNS{loincomtat}{n111}
  
  \nodeunk{139}{(loincomtat.west) ++(-\linkhor,0)}
  \mklinkWE{loincomtat}{n139}
  
  
  \kzcard{foire}{(cuanacht.west) ++(-\linkhor,0)}{\foire{}}{\trade[1XP]{e4v1>}}{Tournois}{}
  \mklinkWE{cuanacht}{foire}
  
  \kzcard{debacle}{(foire.west) ++(-\linkhor,0)}{\debacle{}}{\trade{n1>R1}}{}{}
  \addmenhir{debacle}
  \mklinkWE{foire}{debacle}
  \mklinkNS{debacle}{loincomtat}
  
  \nodeunk{141}{(debacle.west) ++(-\linkhor,0)}
  \mklinkWE{debacle}{n141}

  \nodeunk{120}{(debacle.south) ++(0,-2\linkver)}
  \mklinkSN{debacle}{n120}
