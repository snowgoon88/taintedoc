...
Pour l'heure, nous nous dirigeons vers le sud et les \lames{}. Cette fois, nous ggrimpons tout en haut des gigantesques épées, pour y découvrir que des feuilles d'or couvrent en partie le pommeau \gain{1XP, \rich[2], «1° trésors cachés»}. Ensuite, \beor{} fabrique un bouclier en osier. Avec la nuit, nous rêvons de la première bataille, où \arthur{} fit mettre un genoux à terre au géants \gain{\terror[-1]}.
...
\quest{Visage Serein}{Aller au \visageserein{} et le transformer en Refuge.}
